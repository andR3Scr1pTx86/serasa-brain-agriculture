...
import {
  CROP_REPOSITORY_TOKEN,
  type ICropRepository,
} from '../../domain/repositories/crop.repository.interface.js';
import {
  FARM_REPOSITORY_TOKEN,
  type IFarmRepository,
} from '../../../farms/domain/repositories/farm.repository.interface.js';
import {
  CreateCropInputDto,
  CreateCropOutputDto,
} from '../dtos/create-crop.dto.js';
