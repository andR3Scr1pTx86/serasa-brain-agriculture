...
import { FarmerOrmEntity } from "../../../../farmers/infraestructure/database/entities/farmer-orm.entity.js";
...
export class FarmOrmEntity {
    ...
    @Column({ type: 'decimal', precision: 10, scale: 2, name: 'total_arable_area_ha' })
    totalArableAreaHa: number;

    @Column({ type: 'decimal', precision: 10, scale: 2, name: 'total_vegetation_area_ha' })
