...
import { FarmOrmEntity } from './infrastructure/database/entities/farm-orm.entity.js';
...
import { FarmOrmRepository } from './infrastructure/database/repositories/farm-orm.repository.js';
import { FarmersModule } from '../farmers/farmers.module.js';

@Module({
  imports: [TypeOrmModule.forFeature([FarmOrmEntity]), FarmersModule],
